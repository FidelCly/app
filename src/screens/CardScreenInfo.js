		...
		<View style={styles.container}>
			...
			<View style={styles.description}>
				...
				<Text style={styles.descriptionText}>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sagittis, nisl a sagittis pretium, nunc
					felis congue est, vitae venenatis orci tellus vitae lacus. Proin sed urna nec lectus eleifend
					fringilla.
				</Text>
